...
const CreateNewReq = ({ navigation }) => {
  ...
  const selectAssigned = async (selectedItem) => {
    console.log(selectedItem); // Verify selectedItem is passed correctly
    setAssigned(selectedItem.Name);
    setSubOrdinateKey(selectedItem.id);
  };
            ...
            <View style={{ flexDirection: 'row' }}>
              ...
              >
                <FlatList
                  ...
                  // renderItem={({ item }) => {
                  //   console.log(item); // Check if item is defined
                  //   return (
                  //     <TouchableOpacity onPress={() => {
                  //       console.log(item); // Double-check item here
                  //       selectAssigned(item);
                  //       refRBSheet.current.close();
                  //     }}>
                  //       <Text>{item.Name}</Text>
