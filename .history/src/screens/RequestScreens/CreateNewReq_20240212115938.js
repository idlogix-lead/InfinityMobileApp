...
const CreateNewReq = ({ navigation }) => {
  ...
  return (
    <View style={{ flex: 1,backgroundColor:'red' }}>
      ...
      <View style={{ alignItems: 'center', height: '100%',backgroundColor:'green' }}>
        ...
        <ScrollView style={{ flex: 1 }}>
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', backgroundColor: '#fff', zIndex: 2, padding: 10 }}>
