      ...
      <View style={{ backgroundColor: "white", alignItems: 'center', height: '100%' }}>
        ...
        <ScrollView style={styles.inputContainer}>
          ...
          <View style={{ flexDirection: 'row' }}>
            ...
            <View style={{ width: '50%',flexDirection:'row',backgroundColor:'red' }}>
              <TouchableOpacity style={{ borderWidth: 1, padding: 5, borderRadius: 30,height:32, width: 32, borderColor: 'gray', borderStyle: 'dashed' }}>
                <MaterialCommunityIcons name='calendar-month-outline' size={20} color='gray' />
              </TouchableOpacity>
              <View>
                <Text style={styles.topTxt}>fhdjsk</Text>
              </View>
            </View>
          </View>
