...
const CRMGraph = () => {
  ...
  const dailyOpportunities = [20.5, 35.2, 50.1, 45.3, 60.8, 75.0, 80.9];
  return (
    <ScrollView style={{flex: 1, backgroundColor: '#fff'}}>
      <TouchableOpacity style={{marginTop: 40, marginLeft: 20}}>
        <Entypo name="chevron-left" size={25} color="brown" />
      </TouchableOpacity>
          ...
          <View style={styles.SaleCard}>
            <View>
              <View style={{flexDirection: 'row'}}>
                ...
                <Text style={styles.salesTitle}>Data</Text>
              </View>
      ...
      <View style={{flexDirection: 'row', marginTop: 20, marginLeft: 20}}>
        <View
          ...
          <FontAwesome name="align-center" size={25} color="#000" />
        </View>
      ...
      <View style={{flexDirection: 'row', marginTop: 20, marginLeft: 20}}>
        <View
          ...
          <Entypo name="circular-graph" size={25} color="brown" />
        </View>
        ...
        <View style={styles.salesContainer}>
          ...
          <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
            ...
            <BarChart
              ...
              style={styles.chart}
              decorator={() => {
                return dailyOpportunities.map((value, index) => {
                  const barWidth = (screenWidth * 2) / 12;
                  return (
                    <Svg
                      key={index}
