...
const ApprovalDetails = ({ route }) => {
    ...
    return (
        ...
        <View style={styles.TopBorderStyle}>
            ...
            <View>
                <Text>Partner: {paymentDetails[0].C_BPartner_ID.identifier}</Text>
                <Text>Document No: {paymentDetails[0].DocumentNo}</Text>
                <Text>Date Invoiced: {paymentDetails[0].DateInvoiced}</Text>
                <Text>Doc Type: {paymentDetails[0].C_DocType_ID.identifier}</Text>
                <Text>Total Lines (Exc Amount): {paymentDetails[0].TotalLines.toFixed(2)}</Text>
                <Text>Grand Total (Inc Amount): {paymentDetails[0].GrandTotal.toFixed(2)}</Text>
                <Text>{paymentDetails[0].IsSOTrx ? 'Sales Order Transaction' : 'Invoice Vendor'}</Text>
            </View>
        </View>
    )}
