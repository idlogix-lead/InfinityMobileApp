        ...
        <View style={{ flex: 1 }} >
            ...
            {modelName === 'C_payment' && (
                <View style={styles.TopBorderStyle}>
                    <Text style={[styles.TopTxt, { fontSize: 22, textAlign: 'center',fontFamily:'K2D-Bold' }]}>{paymentDetails[0]?.C_DocType_ID?.identifier}</Text>
            ...
            {(modelName === 'C_Invoice' || modelName === 'C_Order') && (
                <View style={styles.TopBorderStyle}>
                    <Text style={[styles.TopTxt, { fontSize: 22, textAlign: 'center',fontFamily:'K2D-Bold' }]}>{paymentDetails[0]?.IsSOTrx ? 'Invoive Customer' : 'Invoice Vendor'}</Text>
            ...
            {modelName === 'M_Requisition' && (
                <View style={styles.TopBorderStyle}>
                    <Text style={[styles.TitleTxt, { fontSize: 22, textAlign: 'center',fontFamily:'K2D-Bold' }]}>{paymentDetails[0]?.C_DocType_ID?.identifier}</Text>
                    <View style={styles.InsideView}>
                        <Text style={styles.HeadTxt}>DocNo#: </Text>
                        <Text style={styles.TopTxt}>{paymentDetails[0]?.DocumentNo}</Text>
                    </View>
