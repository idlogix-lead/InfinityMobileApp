        ...
        Alert.alert(
            ...
            [
                ...
                },
                {
                    text: 'OK',
                    onPress: () => {
                        const url = `${protocol}://${host}:9999/api/v1/workflow/approve/${item.AD_WF_Activity_ID.id}`;
                        ...
                        fetch(url, {
                            ...
                            headers: {
                                'Content-Type': 'application/json',
                                'Accept': 'application/json',
                                'Authorization': `Bearer ${eyJraWQiOiJpZGVtcGllcmUiLCJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9..tbLYavm_QMr20IGCW3991hNc1xPfzG42GykTUIHxIp7GX28SGAy3dWjU0-abdRUoT3MXNul2rbWLjzdOxLos6Q}`
                            },
                            body: JSON.stringify({
                            ...
                            console.log('Success:', data); // Log the success response data
                            const popArray = dumyArray.filter((item) => item.AD_WF_Activity_ID.id !== itemToRemove);
                            console.log('Filtered Array:', popArray);
                            setDumyArray(popArray);
                            const total = popArray.reduce((accumulator, currentValue) => accumulator + currentValue.TotalLines, 0);
