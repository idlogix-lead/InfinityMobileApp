        ...
        },
        {
          ...
          onPress: () => {
            ...
            fetch(url, {
              ...
              const popArray = dumyArray.filter(
                item => item.AD_WF_Activity_ID.id !== itemToRemove,
              );
    ...
    Alert.alert(
      ...
      [
        ...
        },
        {
          ...
          onPress: () => {
            fetch(
              `${protocol}://${host}:${port}/api/v1/workflow/reject/${item.AD_WF_Activity_ID.id}`,
              {
                method: 'PUT',
                headers: {
                  'Content-Type': 'application/json',
                  ...
                  <View style={styles.card}>
                    ...
                    <View
                      ...
                      <View style={styles.row}>
                        ...
                        <Text style={styles.amount}>
                          ...
                          <Text style={styles.amountValue}>
                            ${item.TotalLines ? item.TotalLines : 'None'}
                          </Text>
                        </Text>
                      </View>
                      ...
                      <View style={styles.row}>
                        ...
                        <Text style={styles.amount}>
                          Created By: <Text style={styles.value}>Zubair </Text>
                        </Text>
                      </View>
