                                ...
                                <View style={styles.CardView}>
                                    ...
                                    <View style={styles.BottomView}>
                                        ...
                                        <View style={styles.InnerCntainer}>
                                            ...
                                            <Text style={styles.InnerTxt}>Unit={item.C_UOM_ID.identifier ? item.C_UOM_ID.identifier : ''}</Text>
                                        </View>
                                        <View style={styles.InnerCntainer}>
                                            <Text style={styles.TopTxt}>Rate</Text>
                                            <Text style={styles.InnerTxt}>{item.PriceActual ? item.PriceActual : ''}</Text>
                                        </View>
                                        <View style={styles.InnerCntainer}>
                                            <Text style={styles.TopTxt}>Amt Exc Tax</Text>
                                            <Text style={styles.InnerTxt}>{item.LineNetAmt ? item.LineNetAmt : ''}</Text>
                                        </View>
                                    </View>
