            ...
            {paymentDetails.length > 0 && (
                <View style={styles.TopBorderStyle}>
                    <View style={styles.TopLeftBorder}>
                        ...
                        <Text style={styles.TopTxt}>DocType: {paymentDetails[0].C_DocType_ID.identifier}</Text>
                    </View>
                    <View style={styles.TopLeftBorder}>
                        <Text style={styles.TopTxt}>GrandTotal: {paymentDetails[0].TotalLines}</Text>
                        <Text style={styles.TopTxt}>TotalLines: {paymentDetails[0].GrandTotal}</Text>
