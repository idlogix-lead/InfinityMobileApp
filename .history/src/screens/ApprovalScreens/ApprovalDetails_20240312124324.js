...
const ApprovalDetails = ({ route }) => {
    ...
    return (
        <View style={{ flex: 1 }} >
            ...
            paymentDetails[0].C_DocType_ID &&
            paymentDetails[0].C_DocType_ID.identifier !== 'No' &&
            paymentDetails[0].DocumentNo !== 'No' &&
            (paymentDetails[0].DateInvoiced !== 'No' || paymentDetails[0].DateDoc !== 'No') &&
            paymentDetails[0].IsSOTrx !== 'No' &&
            paymentDetails[0].TotalLines !== 'No' &&
            paymentDetails[0].GrandTotal !== 'No' &&
            (
