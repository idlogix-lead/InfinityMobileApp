...
const ApprovalDetails = ({ route }) => {
    ...
    const FetchDetails = async () => {
        try {
            ...
            else if (tableId === 1000026)
                mobelname = 'HR_EmpLev_Posting';
            else if (tableId === 224)
                mobelname = 'GL_Journal';
            ...
            if (mobelname === 'C_Invoice' || mobelname === 'M_Requisition' || mobelname === 'C_Order' || mobelname === 'GL_Journal') {
                ...
                <View style={styles.TopBorderStyle}>
                    ...
                    <View style={{ flexDirection: 'row',backgroundColor:'green' }}>
                        <View style={styles.TopLeftBorder}>
                            <View style={[styles.InsideView,{width:'50%'}]}>
                                <Text style={styles.HeadTxt}>DocNo#: </Text>
                                <Text style={styles.TopTxt}>{paymentDetails[0]?.DocumentNo}</Text>
                            </View>
                        </View>
                        <View style={styles.TopLeftBorder}>
                            <View style={[styles.InsideView,{width:'48%',backgroundColor:'blue'}]}>
                                <Text style={styles.HeadTxt}>Date: </Text>
                                <Text style={[styles.TopTxt,{backgroundColor:'red',width:'100%'}]}>{paymentDetails[0]?.DateTrx}</Text>
                            </View>
                        </View>
                    </View>
                </View>
            ...
            {modelName === 'GL_Journal' && (
                <View style={styles.TopBorderStyle}>
                    ...
                    <View style={styles.InsideView}>
                        ...
                        <Text style={styles.TopTxt}>{paymentDetails[0]?.Description}</Text>
                    </View>
                </View>
            )}
                    ...
                    <View style={{ flexDirection: 'row', marginTop: 5 }}>
                        ...
                        <View style={styles.TopLeftBorder}>
                            ...
                            <View style={styles.InsideView}>
                                ...
                                <Text style={styles.TopTxt}>{Math.round(Number(paymentDetails[0]?.TotalLines)).toLocaleString()}</Text>
                            </View>
                            <View style={styles.InsideView}>
                                <Text style={styles.HeadTxt}>Inc Amt: </Text>
                                <Text style={styles.TopTxt}>{Math.round(Number(paymentDetails[0]?.GrandTotal)).toLocaleString()}</Text>
                            </View>
                        </View>
                    </View>
                </View>
                        ...
                        return (
                            <View style={styles.CardView}>
                                ...
                                <View style={styles.BottomView}>
                                    ...
                                    <View style={styles.InnerCntainer}>
                                        <Text style={styles.HeadTxt}>Unit</Text>
                                        <Text style={styles.TopTxt}>{item?.C_UOM_ID?.identifier}</Text>
                                    </View>
                                    <View style={styles.InnerCntainer}>
                                        <Text style={styles.HeadTxt}>Currency</Text>
                                        <Text style={styles.TopTxt}>{item?.C_Currency_ID?.identifier}</Text>
                                    </View>
                                    <View style={styles.InnerCntainer}>
                                ...
                                <View style={styles.BottomView}>
                                    <View style={styles.InnerCntainer}>
                                        <Text style={styles.HeadTxt}>Amt Dr</Text>
                                        <Text style={styles.TopTxt}>{item?.AmtAcctCr}</Text>
                                    </View>
                                    <View style={styles.InnerCntainer}>
                                        <Text style={styles.HeadTxt}>Amt Cr</Text>
                                        <Text style={styles.TopTxt}>{item?.AmtAcctDr}</Text>
                                    </View>
                                    <View style={styles.InnerCntainer}>
                                        <Text style={styles.HeadTxt}>Source Dr</Text>
                                        <Text style={styles.TopTxt}>{item?.AmtSourceDr}</Text>
                                    </View>
                                    <View style={styles.InnerCntainer}>
                                        <Text style={styles.HeadTxt}>Source Cr</Text>
                                        <Text style={styles.TopTxt}>{item?.AmtSourceCr}</Text>
                                    </View>
                                </View>
                            </View>
                        )
