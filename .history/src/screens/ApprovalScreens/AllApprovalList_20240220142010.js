                    ...
                    onPress: () => {
                        ...
                        fetch(url, {
                            ...
                            headers: {
                                'Content-Type': 'application/json',
                                'Accept': 'application/json',
                                'Authorization': 'eyJraWQiOiJpZGVtcGllcmUiLCJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9..tbLYavm_QMr20IGCW3991hNc1xPfzG42GykTUIHxIp7GX28SGAy3dWjU0-abdRUoT3MXNul2rbWLjzdOxLos6Q'
                            },
                            body: JSON.stringify({
