    ...
    return (
        ...
        <View style={styles.TopBorderStyle}>
            ...
            <View  style={styles.TopLeftBorder}>
                ...
                <Text style={styles.TopTxt}>Total Lines (Exc Amount): {paymentDetails[0].TotalLines}</Text>
                <Text style={styles.TopTxt}>Grand Total (Inc Amount): {paymentDetails[0].GrandTotal}</Text>
