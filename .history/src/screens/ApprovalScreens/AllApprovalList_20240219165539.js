...
import {StyleSheet, Text, FlatList, View, TouchableOpacity, Image, Dimensions, TextInput, Alert, ActivityIndicator,
} from 'react-native'
...
const AllApprovalList = ({ navigation }) => {
    ...
    // console.log(JSON.stringify(approvalItems,'f'))
