                ...
                <FlatList
                    ...
                    renderItem={({ item }) => {
                        return (
                            <View style={styles.CardView}>
                                <Text style={styles.ItemName}>{item.M_Product_ID?.identifier || item.C_Charge_ID?.identifier || ''}</Text>
                                <View style={{ flexDirection: 'row', marginLeft: 10, width:'97%',backgroundColor:'red' }}>
                                    <Text style={styles.HeadTxt}>Business Partner: </Text>
                                    <Text style={[styles.TopTxt,{backgroundColor:'green',width:'60%'}]}>{item.C_BPartner_ID?.identifier}</Text>
                                </View>
                                <View style={styles.BottomView}>
                                    <View style={styles.InnerCntainer}>
                                        <Text style={styles.HeadTxt}>Qty</Text>
                                ...
                                <View style={styles.BottomView}>
                                    ...
                                    <View style={styles.InnerCntainer}>
                                        <Text style={styles.HeadTxt}>Tax amt</Text>
                                        <Text style={styles.TopTxt}></Text>
                                    </View>
                                    <View style={styles.InnerCntainer}>
                                        <Text style={styles.HeadTxt}>Amt Inc Tax</Text>
                                        <Text style={styles.TopTxt}></Text>
                                    </View>
                                </View>
                            </View>
