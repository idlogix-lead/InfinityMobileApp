    ...
    return (
        <View style={{ flex: 1,  }}>
            ...
            <CardCompanyInformation
                ...
                Icon={<FontAwesome5 name='user-tie' size={25} color='#877e7e'/>}
                // source={require('../../asserts/CompanyInformationScreen/Client.png')} 
                text='Test Client'
                 />
            ...
            <CardCompanyInformation
                ...
                Icon={<FontAwesome5 name='user-check' size={25} color='#877e7e'/>}
                // source={require('../../asserts/CompanyInformationScreen/Male.png')}
                 text='Test Client' />

            <CardCompanyInformation
                topText="Organization"
                secondtext={roleName}
                Icon={<FontAwesome6 name='users-viewfinder' size={25} color='#877e7e'/>}
                // source={require('../../asserts/CompanyInformationScreen/Network.png')}
                 text='Test Client' />
            ...
            <CardCompanyInformation
                ...
                Icon={<MaterialCommunityIcons name='warehouse' size={25} color='#877e7e'/>}
                // source={require('../../asserts/CompanyInformationScreen/Warehouse.png')} 
                text='Test Client' />
        </View>
    )
}
