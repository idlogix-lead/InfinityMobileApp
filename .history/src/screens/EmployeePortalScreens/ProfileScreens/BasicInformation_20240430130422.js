    ...
    <ScrollView style={{ flex: 1 }}>
      <View style={{marginBottom:50}}>
        ...
        <SalarySlipCardView
          ...
          TitleText={'Gender'}
          Txt={employeeData?.Gender?.identifier ? employeeData?.Gender?.identifier :'null'}
        />
        <SalarySlipCardView
        ...
        <SalarySlipCardView
          ...
          Txt={employeeData?.Blood_Group?.identifier ? employeeData?.Blood_Group?.identifier : 'null'}
        />
        <SalarySlipCardView
          Icon={<FontAwesome5 name='praying-hands' size={size} color={color} />}
          TitleText={'Religion'}
          Txt={employeeData?.Religion?.identifier ? employeeData?.Religion?.identifier : 'null'}
        />
        ...
        <SalarySlipCardView
          ...
          Txt={employeeData.Date_Cnicissue ? employeeData.Date_Cnicissue : 'null'}
        />
        <SalarySlipCardView
          Icon={<MaterialIcons name="event" size={size} color={color} />}
          TitleText={'Date_Cnicexpire'}
          Txt={employeeData.Date_Cnicexpire ? employeeData.Date_Cnicexpire : 'null'} 
        />
        <SalarySlipCardView
          Icon={<MaterialCommunityIcons name="heart" size={size} color={color} />}
          TitleText={'MaritalStatus'}
          Txt={employeeData?.MaritalStatus?.identifier ? employeeData?.MaritalStatus?.identifier : 'null'}
        />
        <SalarySlipCardView
        ...
        <SalarySlipCardView
          ...
          Txt={employeeData.date_licexpire ? employeeData.date_licexpire : 'null'}
        />
        <SalarySlipCardView
          Icon={<MaterialIcons name="business" size={size} color={color} />}
          TitleText={'HR_Department_ID'}
          Txt={employeeData?.HR_Department_ID?.identifier ? employeeData?.HR_Department_ID?.identifier : 'null'}
        />
        <SalarySlipCardView
          Icon={<MaterialIcons name="work" size={size} color={color} />}
          TitleText={'HR_Job_ID'}
          Txt={employeeData?.HR_Job_ID?.identifier ? employeeData?.HR_Job_ID?.identifier : 'null'}
        />
        <SalarySlipCardView
          Icon={<MaterialCommunityIcons name="calendar" size={size} color={color} />}
