  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <Picker
          ...
          selectedValue={selectedPeriod} // Use selectedPeriod instead of pickerResponse
          onValueChange={(itemValue, itemIndex) => setSelectedPeriod(itemValue)} // Set selectedPeriod instead of pickerResponse
        >
