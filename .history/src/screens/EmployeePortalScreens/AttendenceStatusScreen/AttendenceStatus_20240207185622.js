...
const AttendenceStatus = ({ navigation }) => {
    ...
    const getTotalAttendence = async () => {
        ...
        try {
            setIsLoading(true);
            console.log(sDate,'selectedStartDate')
            console.log(eDate,'selectedEndDate')
    ...
    const onDateChange = (date,type) => {
        ...
        console.log(sDate,'on out filterAttendanceRecords')
        if (!selectedStartDate) {
            // setSelectedStartDate(formattedDate);
            setSDate(formattedDate);
            setEDate(formattedDate);
        console.log(sDate,'on in sdate')
        } else if (selectedStartDate && !selectedEndDate) {
            // setSelectedEndDate(formattedDate);
            setEDate(formattedDate);
        console.log(eDate,'on else in edate')
        } else {
            // setSelectedStartDate(formattedDate);
            // setSelectedEndDate(formattedDate);
            setSDate(formattedDate);
            setEDate(formattedDate);
            console.log(eDate,'on in sdate edate')
        }
    };
    ...
    const filterAttendanceRecords = () => {
        ...
        // console.log(selectedStartDate,'on in sstdate')
