...
const AnnualLeave = ({navigation, route}) => {
    ...
    useEffect(() => {
        if (route.params?.record) {
            ...
            // console.log(record)
            // Set the state variables using the data from record
            ...
            // Assuming organizations and leaveTypes are already loaded,
            // if not, you need to ensure they are loaded before setting these
