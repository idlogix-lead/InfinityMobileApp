...
const AnnualLeave = ({ navigation, route }) => {
    ...
    const UpdateData = async () => {
        ...
        const port = await AsyncStorage.getItem('port');
        const token = await AsyncStorage.getItem('token');
        console.log(selectedOrganization.AD_Org_ID.identifier,'orga name')
        console.log(selectedOrganization.AD_Org_ID.id,'orga id')
        console.log(startDate,'start')
        console.log(endDate,'start')
        console.log(selectedLeaveType,'leve typ')
        console.log(leaveTypes.find(type => type.value === selectedLeaveType)?.label || '','leve id')
        console.log(description,'descr')
        console.log(selectedYearId,'year id')
        console.log(selectedYearLabel,'year ')
