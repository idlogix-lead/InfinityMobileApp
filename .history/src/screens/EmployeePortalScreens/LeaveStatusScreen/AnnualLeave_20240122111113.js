...
const AnnualLeave = () => {
    ...
    const Save = async () => {
        if (startDate === null) {
            Alert.alert('start data cannot be null')
        } else if (endDate === null) {
            Alert.alert('End data cannot be null')
        } else if (selectedLeaveType === null) {
            Alert.alert('Leave Type cannot be null')
        } else if (selectedYearLabel === null) {
            Alert.alert('Document Status cannot be null')
        } else if (description === '') {
                ...
                <View style={{ marginBottom: '7%' }}>
                    ...
                    <View style={styles.startDate}>
                        <TextInput
                            ...
                            style={{color: 'gray', marginLeft: 5, backgroundColor:'red'}}
