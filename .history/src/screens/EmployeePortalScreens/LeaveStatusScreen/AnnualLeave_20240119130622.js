...
const AnnualLeave = () => {
    ...
    const FindBusinessPrtId = async () => {
        ...
        try {
            const response = await axios.get(`${protocol}://${host}:${port}/api/v1/models/AD_User?$filter=AD_User_ID eq ${Id}`,
                ...
                console.log(response.data.records,'fd')
    ...
    const SaveData = async () => {
        ...
        console.log(clientId,'cli id')
        console.log(clientName,'name')
        console.log(organizationId,'org id')
        console.log(partnerId,'ptnr id')
        console.log(formattedDate,'faoma')
            ...
            const response = await axios.post(`${protocol}://${host}:${port}/api/v1/models/HR_EmpLev_Posting`,
                {
                    ...
                    body: ({
                        ...
                        'AD_Org_ID': { 'id': organizationId, 'identifier': organizationId },
