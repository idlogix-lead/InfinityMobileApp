...
const StaffAttendance = () => {
    ...
    const getProcessedAttandance = async () => {
        if (!hasMorePages || isLoadingMore) return; // Prevent multiple calls
        ...
        try {
            ...
            setTotalPages(newTotalPages); // Update total pages based on response
            ...
            if (currentPage === 1) setIsLoading(false); // Only set isLoading to false on the initial load
        }
    };
