...
const StaffAttendance = () => {
    ...
    const page_size = 10;
    {/* For Processed data*/ }
    const getProcessedAttendance = async () => {
        ...
        try {
            ...
            const totalPages = Math.ceil(response.data['row-count'] / page_size);
            const newProcessed = currentPage === 1 ? response.data.records : [...processed, ...response.data.records];
