...
const StaffAttendance = () => {
    ...
    const getProcessedAttandance = async () => {
        ...
        let { firstDayOfMonth, lastDayOfMonth } = getCurrentMonthDates();
        let startDate = selectedStartDate || firstDayOfMonth;
        let endDate = selectedEndDate || lastDayOfMonth;
        ...
        if (selectedStartDate && selectedEndDate) conditions.push(`AttDate ge ${startDate} and AttDate le ${endDate}`);
