...
const StaffAttendance = () => {
    ...
    const getProcessedAttandance = async () => {
        ...
        // Add condition for business partner if provided
        if (searchQuery) {
            conditions.push(`business_partner eq '${encodeURIComponent(searchQuery)}'`);
        }
    
        // Add condition for department if provided
        if (searchDepartment) {
            conditions.push(`department eq '${encodeURIComponent(searchDepartment)}'`);
        }
    
        // Add condition for subdepartment if provided
        if (searchSubDepartment) {
            conditions.push(`subdepartment eq '${encodeURIComponent(searchSubDepartment)}'`);
        }
    
        // Add condition for date range if both dates are provided
        if (selectedStartDate && selectedEndDate) {
            conditions.push(`AttDate ge ${encodeURIComponent(selectedStartDate)} and AttDate le ${encodeURIComponent(selectedEndDate)}`);
        }
