...
const StaffAttendance = () => {
    ...
    const getProcessedAttandance = async () => {
        ...
        console.log(searchQuery,'ddddd')

        let queryParams = `$filter=`;
        let conditions = [];
        if (searchQuery) conditions.push(`business_partner eq 'Abdul Rehman'`);
    ...
    const onChangeSearch = async (query) => {
        ...
        console.log(searchQuery,'searchQuerysss')
