...
const StaffAttendance = () => {
    ...
    const [filteredEmployeeSuggestions, setFilteredEmployeeSuggestions] = useState([]);
    ...
    const getEmployeeName = async () => {
        ...
        try {
            ...
            setFilteredEmployeeSuggestions(employeeData);
        } catch (error) {
            console.log('Error', error)
        } finally {
            setIsLoading(false);
    ...
    const onChangeSearch = query => {
        ...
        const filteredData = employeeSuggestions.filter(item =>
            item.Name.toLowerCase().includes(query.toLowerCase())
        );
        setFilteredEmployeeSuggestions(filteredData);
    };
                                ...
                                <View>
                                    ...
                                    {searchQuery.length > 0 && (
                                        <View style={styles.EmployeeFilterView}>
                                            <FlatList
                                                data={filteredEmployeeSuggestions}
