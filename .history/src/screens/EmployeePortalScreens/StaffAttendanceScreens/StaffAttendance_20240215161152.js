...
const StaffAttendance = () => {
    ...
    const getProcessedAttandance = async (page) => {
        ...
        try {
            const response = await axios.get(URL,
                ...
                const pagess= totalPages/page_size
                console.log(pagess)
                console.log(totalPages,'fg')
    ...
    const onChangeSearch = async (query) => {
        ...
        //     console.log(query,'q')
        //     try {
        //         const response = await axios.get(`${protocol}://${host}:${port}/api/v1/models/C_BPartner?$select=Name,IsEmployee&$filter=contains(Name, '${query}') and IsEmployee eq true`,
        //             {
        //                 method: 'GET',
        //                 headers: {
        //                     'Content-Type': 'application/json',
