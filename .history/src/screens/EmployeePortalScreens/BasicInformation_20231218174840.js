    ...
    <View style={{flex:1}}>
        ...
        <View style={styles.ContainerView}>
          <View style={styles.IconView}>
            <MaterialIcons name='person' size={25} color='#0050c0'/>
          </View>
          <View>
        ...
        <View style={styles.ContainerView}>
          <View style={styles.IconView}>
          <MaterialIcons name='transgender' size={25} color='#0050c0'/>
          </View>
          <View>
        ...
        <View style={styles.ContainerView}>
          <View style={styles.IconView}>
            <MaterialCommunityIcons name='calendar-account' size={25} color='#0050c0'/>
          </View>
          <View>
        ...
        <View style={styles.ContainerView}>
          <View style={styles.IconView}>
          <MaterialIcons name='bloodtype' size={25} color='#0050c0'/>
          </View>
          <View>
        ...
        <View style={styles.ContainerView}>
          <View style={styles.IconView}>
          <MaterialCommunityIcons name='star-david' size={25} color='#0050c0'/>
          </View>
          <View>
