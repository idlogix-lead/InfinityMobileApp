...
const ProfileScreen = ({ navigation }) => {
  ...
  const switchAccount = async (userName) => {
    ...
    try {
      ...
      console.log(usersArray, 'Loaded users data'); // Debugging: Log loaded users data
  
      const selectedUser = usersArray.find(user => user.userName === userName);
      console.log(selectedUser, 'Selected user data'); // Debugging: Log selected user data
      ...
      // Assuming you have a function to update UI or navigate after switching
      setSelectedUserName(userName); // Update local state
      console.log("Account switched successfully to", userName);
      // Refresh UI or navigate as necessary
