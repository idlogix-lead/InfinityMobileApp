...
// console.log(date,'date')
    ...
    date.set({ hour: 18, minute: 47, second: 0, millisecond: 0 });
    const formattedTime = date.format("HH:mm:ss'Z'");
    ...
    try {
      console.log(formattedTime,'dddddd')


      const payload = {"AD_Client_ID": 1000000, "AD_Org_ID": 1000001, "AttActivity": "000", "AttDate": "2024-08-09", "AttStatus": "OUT", "AttTime": "18:47:00Z", "C_BPartner_ID": 1000319, "C_Year_ID": {"id": "1000014", "identifier": "2024"}, "MyConDate": "2024/08/09/ 19:20", "latitude": 31.4752127, "longitude": 74.2706586}
