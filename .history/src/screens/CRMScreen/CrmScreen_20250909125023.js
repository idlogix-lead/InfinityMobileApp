...
const CrmScreen = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{flexDirection: 'row'}}>
        <View style={{marginLeft: 20, marginBottom: 10}}>
          ...
          <TouchableOpacity
            ...
            <ImageBackground
              source={require('../../asserts/Crm/CRM-B3.png')}
              style={styles.leadCardBg}
          ...
          {/* <ImageBackground source={require('../../asserts/Crm/CRM-B3.png')} />
        <TouchableOpacity
          onPress={() => {
            navigation.navigate('CrmTotal', {
              totalLeads: totalLeadsData,
        ...
        <TouchableOpacity
          ...
          style={[styles.leadCard, {backgroundColor: '#ebecf9', right: 20}]}>
          <View style={{flexDirection: 'row'}}>
            <Image
              style={styles.leadImage}
      ...
      {/* Leads Section */}
      <View style={styles.leadsContainer}></View>
      ...
      <TouchableOpacity
        onPress={() => navigation.navigate('CRMGraph')}
        style={{
          backgroundColor: '#fff',
          height: 50,
          width: 50,
...
const styles = StyleSheet.create({
  container: {flex: 1, backgroundColor: '#2F4FE2'},
  header: {
    flexDirection: 'row',
