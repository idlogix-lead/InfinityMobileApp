    ...
    <View style={styles.container}>
      ...
      <View style={styles.leadsContainer}>
        <TouchableOpacity
          ...
          <View style={{flexDirection: 'row'}}>
            {/* <Image
              ...
              source={require('../../asserts/CRMIcons/newleads.png')}
            /> */}
            <View>
        ...
        <TouchableOpacity
          ...
          <View style={{flexDirection: 'row'}}>
            {/* <Image
              style={styles.leadImage}
              source={require('../../asserts/CRMIcons/leads.png')}
            /> */}
            <View>
      ...
      <View style={styles.buttonContainer}>
        <TouchableOpacity
          ...
          //     });
          //   }}
          style={styles.convertedButton}>
          <View style={styles.buttonIcon}>
            <Octicons name="sync" size={20} color={'black'} />
          </View>
          <Text style={{color: '#000', marginLeft: 5}}>Converted Leads</Text>
        ...
        <TouchableOpacity
          ...
          <Text style={{color: '#000', marginLeft: 5}}>Expire Leads</Text>
          <Entypo name="chevron-right" size={20} color={'black'} />
        </TouchableOpacity>
      </View>
