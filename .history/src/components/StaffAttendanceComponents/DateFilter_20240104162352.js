...
const DateFilter = ({ processedData, unprocessedData, onFilterApply }) => {
    ...
    const filterData = () => {
        ...
        const filteredProcessedData = filterByDate(processedData);
        const filteredUnprocessedData = filterByDate(unprocessedData);
    
        onFilterApply(filteredProcessedData, filteredUnprocessedData);
    };
