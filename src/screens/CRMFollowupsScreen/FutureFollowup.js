...
const MissedFollowUp = () => {
      ...
      <View style={styles.card}>
        ...
        <TouchableOpacity
          ...
          <Text
            ...
            {item.IsComplete ? 'Complete' : 'Incomplete'}<Text style={styles.label}> : </Text>
          </Text>
          <View
            style={{
              width: 20,
        ...
        <View style={{marginTop: 10, marginBottom: 10, position: 'relative'}}>
          ...
          {/* Follow-up Type */}
          <View style={styles.infoContainer}>
            <Text style={[styles.subLabel,{paddingHorizontal:'4%',paddingTop:'3%'}]}>Follow-up type:</Text>
            <Text
              style={[
                styles.subValue,
                { color: 'rgba(21, 68, 137, 1)', backgroundColor:"#f0f0f0",elevation:2,paddingHorizontal:'3%',borderRadius:5},
              ]}>
              {followUpType}
            </Text>
          </View>
  ...
  return (
    <View style={styles.container}>
      <SearchHeader />
      <Text style={styles.title}>Future Follow-ups</Text>
      <FlatList
