...
const categories = [
  { title: 'Reports', icon: 'file-document-outline', color: '#5AC8FA' },
  { title: 'Approval', icon: 'check-decagram', color: '#FBBF24' },
  { title: 'Employee Portal', icon: 'account-group', color: '#6366F1' },
  { title: 'Request', icon: 'file-send', color: '#EF4444' },
];

const transactions = [
  { amount: '$54.67', name: 'Sharlin Jason', date: '1-2-2025', status: 'Pending' },
  { amount: '$54.67', name: 'Sharlin Jason', date: '1-2-2025', status: 'Complete' },
  { amount: '$54.67', name: 'Sharlin Jason', date: '1-2-2025', status: 'Complete' },
];

const HomeScreen = () => {
  const renderCategory = ({ title, icon, color }) => (
    <TouchableOpacity style={styles.categoryBox} key={title}>
  ...
  const renderTransaction = ({ item }) => (
    <View style={styles.transactionBox}>
      ...
      <View style={[styles.status, item.status === 'Complete' ? styles.statusComplete : styles.statusPending]}>
    ...
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={styles.profileInfo}>
          <Text style={styles.name}>Umair Maqbool</Text>
      ...
      <Text style={styles.date}>4\9\2025</Text>
