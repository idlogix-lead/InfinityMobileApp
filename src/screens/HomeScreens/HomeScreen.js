...
import { FlatList, StyleSheet, Text, View, Dimensions, BackHandler, ActivityIndicator, PermissionsAndroid, TouchableOpacity, Alert, StatusBar, Image, ImageBackground } from 'react-native'
import React, { useCallback, useEffect, useState } from 'react'
import TopHeader from '../../components/HomeScreenComponents/TopHeader'
import NameContainer from '../../components/HomeScreenComponents/NameContainer'
import HomeCard from '../../components/HomeScreenComponents/HomeCard'
      ...
      <View style={styles.header}>
        ...
        <View style={styles.profileInfo}>
          <Image
            ...
            style={{ width: 76, height: 70, alignSelf: "center" }}
          />
          <Text style={[styles.name, { fontSize: 20, marginTop: "4%", color: "#fff" }]}>{name}</Text>
